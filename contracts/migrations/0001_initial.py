    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_directors_approval', models.CharField(choices=[('YES', 'Yes'), ('NO', 'No')], default='NO', verbose_name='Directors Approval')),
                ...
                ('is_ooc', models.CharField(choices=[('YES', 'Yes'), ('NO', 'No')], default='NO', verbose_name='Out Of Contract')),
                ...
                ('vat_declaration_sent', models.CharField(choices=[('YES', 'Yes'), ('NO', 'No')], default='NO', verbose_name='Vat Declaration Sent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_manager', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='client_manager_contracts', to='users.clientmanager', verbose_name='Client Manager')),
